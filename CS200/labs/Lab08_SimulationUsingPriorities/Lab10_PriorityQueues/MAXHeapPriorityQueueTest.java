...
/**
 * A JUnit test case class for class <FOO>MAXHeapPriorityQueue  
 * 
 * @author Imad M Rahal
...
public class MAXHeapPriorityQueueTest{
  ...
  @Before
  public void init(){
    nonEmptyPQ = new <FOO>MAXHeapPriorityQueue<Integer>();
    emptyPQ = new <FOO>MAXHeapPriorityQueue<Integer>(5);
  ...
  public void testConstructorFailsNegativeCapacity(){
    emptyPQ = new <FOO>MAXHeapPriorityQueue<Integer>(-1);
  }
  @Test(expected=IllegalArgumentException.class)
  public void testConstructorFailsZeroCapacity(){
    emptyPQ = new <FOO>MAXHeapPriorityQueue<Integer>(0);
  }
