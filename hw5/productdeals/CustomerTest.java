...
public class CustomerTest {
  ...
  public void testGetTransactionParts() throws Exception{
    ...
    if(rs.next()){
      ...
      Assert.assertTrue(rs.getString("PART_DESCRIPTION").trim().equals("Dartboard"));
      if(rs.next()){       
        Assert.assertTrue(rs.getString("PART_NUMBER").equals("BA74"));
        Assert.assertTrue(rs.getString("PART_DESCRIPTION").trim().equals("Basketball"));
      }
      else
